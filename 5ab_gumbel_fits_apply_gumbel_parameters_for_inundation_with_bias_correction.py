...
input_files["future"]['file_name']['channelStorage'] = input_files["future"]['folder'] + "/" + "gumbel_analysis_bias_corrected_output_for_channel_storage.nc" 
input_files["future"]['file_name']['floodVolume'   ] = input_files["future"]['folder'] + "/" + "gumbel_analysis_bias_corrected_output_for_flood_inundation_volume.nc" 
