...
################################################################################################
#
# Downscaling BIAS-CORRECTED floods - rcp4p5 - miroc-esm-chem - inunriver_rcp4p5_MIROC-ESM-CHEM
#
################################################################################################
#
# 2010-2049 (2030)
...
python 7_merging_downscaled_maps_with_masking_out_and_following_name_convention.py "/scratch/shared/edwin/flood_analyzer_analysis_june_2017/rcp4p5/2050-2099/miroc-esm-chem/inundation_downscaled/bias_corrected/" "/scratch/shared/edwin/flood_analyzer_analysis_june_2017/rcp4p5/2050-2099/miroc-esm-chem/inundation_downscaled/bias_corrected/" inunriver_rcp4p5_MIROC-ESM-CHEM_2080 2050 2099 channel_storage.map 06
#
#
################################################################################################
...
################################################################################################
#
# Downscaling NON-bias_corrected floods - rcp4p5 - miroc-esm-chem - inunriver_rcp4p5_MIROC-ESM-CHEM
#
################################################################################################
#
# 2010-2049 (2030)
...
# - merging all downscaled map
python 7_merging_downscaled_maps_with_masking_out_and_following_name_convention.py "/scratch/shared/edwin/flood_analyzer_analysis_june_2017/rcp4p5/2050-2099/miroc-esm-chem/inundation_downscaled/including_bias/" "/scratch/shared/edwin/flood_analyzer_analysis_june_2017/rcp4p5/2050-2099/miroc-esm-chem/inundation_downscaled/including_bias/" inunriver_rcp4p5_MIROC-ESM-CHEM_2080 2050 2099 channel_storage.map 06
#
#
################################################################################################
