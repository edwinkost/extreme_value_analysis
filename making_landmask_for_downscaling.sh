...
resample --clone merged_ldd_30sec.map ../landmask_extreme_value_analysis/landmask_extreme_value_analysis_05min.map landmask_extreme_value_analysis_05min_30sec.map 
