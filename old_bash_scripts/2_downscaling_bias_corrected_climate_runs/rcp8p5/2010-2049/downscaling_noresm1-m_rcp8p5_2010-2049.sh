...
# - Which gcm? There are three formats: NorESM1-M and 00000NorESM1-M and noresm1-m (please be careful during find and replace-ing). 
# - Which time period?
...
# job name
#SBATCH -J rcp8p5_NorESM1-M_2030
...
FORCING_NAME=NorESM1-M

# nc filename convention:inunriver_rcp8p5_00000000000000_$MID_PERIOD
NETCDF_OUTPUT_CONVENTION=inunriver_rcp8p5_00000NorESM1-M_$MID_PERIOD
...
EXTREME_VALUE_INPUT_FOLDER=/projects/0/aqueduct/users/edwinsut/aqueduct_flood_analyzer_results/version_2016_12_11/flood_analyzer_analysis/rcp8p5/bias_corrected_flood_analyzer_analysis_rcp8p5_runs_2010-2049/rcp8p5/extreme_values_bias_corrected/noresm1-m_2010-2049/
