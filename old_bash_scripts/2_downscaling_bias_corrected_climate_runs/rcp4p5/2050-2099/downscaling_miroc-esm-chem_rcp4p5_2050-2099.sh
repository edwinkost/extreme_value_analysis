...
# job name
#SBATCH -J rcp4p5_MIROC-ESM-CHEM_2080
...
EXTREME_VALUE_INPUT_FOLDER=/projects/0/aqueduct/users/edwinsut/flood_analyzer_analysis_may_june_2017/rcp4p5/2050-2099/miroc-esm-chem/extreme_values/channel_storage/
