...
# - Which gcm? There are three formats: HadGEM2-ES and 0000HadGEM2-ES and hadgem2-es (please be careful during find and replace-ing). 
# - Which time period?
...
# job name
#SBATCH -J rcp8p5_HadGEM2-ES_2050
...
FORCING_NAME=HadGEM2-ES

# nc filename convention:inunriver_rcp8p5_00000000000000_$MID_PERIOD
NETCDF_OUTPUT_CONVENTION=inunriver_rcp8p5_0000HadGEM2-ES_$MID_PERIOD

MERGED_MAP_OUTPUT_FOLDER=/scratch-shared/edwinsut/flood_inundation_2018_02_XX/inundation_30sec/rcp8p5/$STA_PERIOD-$END_PERIOD/$FORCING_NAME/merged/

UNMERGED_MAP_OUTPUT_FOLDER=/scratch-shared/edwinsut/flood_inundation_2018_02_XX/inundation_30sec/rcp8p5/$STA_PERIOD-$END_PERIOD/$FORCING_NAME/before_merged/

EXTREME_VALUE_INPUT_FOLDER=/projects/0/aqueduct/users/edwinsut/aqueduct_flood_analyzer_results/version_2016_12_11/flood_analyzer_analysis/rcp8p5/bias_corrected_flood_analyzer_analysis_rcp8p5_runs_2030-2069/rcp8p5/extreme_values_bias_corrected/hadgem2-es_2030-2069/
