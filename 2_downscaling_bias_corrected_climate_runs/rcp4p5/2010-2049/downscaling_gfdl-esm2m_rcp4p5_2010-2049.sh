...
# - Which time period?
# - Check the output folders: MERGED_MAP_OUTPUT_FOLDER and UNMERGED_MAP_OUTPUT_FOLDER
# - Set the input folder: EXTREME_VALUE_INPUT_FOLDER

###################################################################################################################################

# job name
#SBATCH -J rcp4p5_GFDL-ESM2M_1980
...
MERGED_MAP_OUTPUT_FOLDER=/scratch-shared/edwinsut/flood_inundation_2018_02_XX/merged/rcp4p5/GFDL-ESM2M/$STA_PERIOD-$END_PERIOD/

UNMERGED_MAP_OUTPUT_FOLDER=/scratch-shared/edwinsut/flood_inundation_2018_02_XX/before_merged/rcp4p5/GFDL-ESM2M/$STA_PERIOD-$END_PERIOD/

EXTREME_VALUE_INPUT_FOLDER=/projects/0/aqueduct/users/edwinsut/aqueduct_flood_analyzer_results/version_2016_12_11/flood_analyzer_analysis/rcp4p5/bias_corrected_flood_analyzer_analysis_rcp4p5_runs_2010-2049/rcp4p5/extreme_values_bias_corrected/gfdl-esm2m_2010-2049/
