...
# job name
#SBATCH -J rcp6p0_MIROC-ESM-CHEM_2080
...
NETCDF_OUTPUT_CONVENTION=inunriver_rcp6p0_MIROC-ESM-CHEM_$MID_PERIOD
...
EXTREME_VALUE_INPUT_FOLDER=/projects/0/aqueduct/users/edwinsut/flood_analyzer_analysis_may_june_2017/rcp6p0/2050-2099/miroc-esm-chem/extreme_values/channel_storage/
