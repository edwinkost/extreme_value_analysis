...
Assuming Cartesius is running ok (and not in maintenance) and that the jobs are picked up quickly. Basically this means we can complete the runs in ca 4-5 days after Cartesius picks the jobs up – the length of the queue and business of the supercomputer is of course out of our control.
