...
# job name
#SBATCH -J rcp6p0_2080_miroc-esm-chem
...
#
PCRGLOBWB_OUTPUT_FOLDER=/projects/0/aqueduct/users/edwinsut/pcrglobwb_runs_2017_feb_rcp6p0/pcrglobwb_4_land_covers_edwin_parameter_set_${GCM_SMALL_LETTERS}/no_correction/${RCP_CODE}/merged_2006-2099/
#
