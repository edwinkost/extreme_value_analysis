...
# job name
#SBATCH -J rcp2p6_2080_miroc-esm-chem
...
#
MAIN_OUTPUT_FOLDER=/scratch-shared/edwinhs/flood_analyzer_analysis_2018_05_XX/
#
RCP_CODE=rcp2p6
#
STA_PERIOD=2060
...
#
PCRGLOBWB_OUTPUT_FOLDER=/projects/0/aqueduct/users/edwinsut/pcrglobwb_runs_2017_may_jun_rcp2p6/pcrglobwb_4_land_covers_edwin_parameter_set_${GCM_SMALL_LETTERS}/no_correction/${RCP_CODE}/merged_2006-2099/
#
