...
# job name
#SBATCH -J watch_downscaling_sorder_6_edwinhs
...
python 7_merging_downscaled_maps_with_masking_out_and_following_name_convention.py ${MAIN_INPUT_FOLDER}/${RCP_CODE}/1960-1999/${GCM_CAPITAL_LETTERS}/inundation_30sec/before_merged/ ${MAIN_OUTPUT_FOLDER}/${RCP_CODE}/1960-1999/${GCM_CAPITAL_LETTERS}/inundation_30sec/merged/ inunriver_${RCP_CODE}_${GCM_CONVENTION_NAME}_1980 1960 1999 channel_storage.map 0${STRAHLER_ORDER}
#
#
###################################################################################
