...
$Author: winsemi $
$Revision: 733 $
$HeadURL: https://repos.deltares.nl/repos/Hydrology/trunk/GLOFRIS/src/GLOFRIS_downscale/downscale_flood_volume.py $
$Keywords: $
"""
...
try:
    ...
    for region, stream_thres, relevant_T in map(None, regions, stream_thres_all, relevant_T_all):
        ...
        del yc, xc
        """
        Now process per return period the flood maps
        """
        for n in arange(0, nrExtremes):
            if p_relevant[n] > 0:
