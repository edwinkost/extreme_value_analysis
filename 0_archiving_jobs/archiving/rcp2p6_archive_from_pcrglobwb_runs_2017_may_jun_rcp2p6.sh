...
# archiving 
cd ${SOURCE_DIRECTORY}
7za a ${TARGET_DIRECTORY}/pcrglobwb_4_land_covers_edwin_parameter_set_gfdl-esm2m.7z                        pcrglobwb_4_land_covers_edwin_parameter_set_gfdl-esm2m/no_correction/rcp2p6                        &
7za a ${TARGET_DIRECTORY}/pcrglobwb_4_land_covers_edwin_parameter_set_hadgem2-es.7z                        pcrglobwb_4_land_covers_edwin_parameter_set_hadgem2-es/no_correction/rcp2p6                        &
7za a ${TARGET_DIRECTORY}/pcrglobwb_4_land_covers_edwin_parameter_set_ipsl-cm5a-lr.7z                      pcrglobwb_4_land_covers_edwin_parameter_set_ipsl-cm5a-lr/no_correction/rcp2p6                      &
7za a ${TARGET_DIRECTORY}/pcrglobwb_4_land_covers_edwin_parameter_set_miroc-esm-chem.7z                    pcrglobwb_4_land_covers_edwin_parameter_set_miroc-esm-chem/no_correction/rcp2p6                    &
7za a ${TARGET_DIRECTORY}/pcrglobwb_4_land_covers_edwin_parameter_set_noresm1-m.7z                         pcrglobwb_4_land_covers_edwin_parameter_set_noresm1-m/no_correction/rcp2p6                         &
wait
