...
#SBATCH -J copy_rcp4p5_archive

date

MAIN_SOURCE_FOLDER="/archive/edwinsut/aqueduct_flood_analyzer/pcrglobwb_runs/rcp4p5/"
MAIN_TARGET_FOLDER="/archive/edwin/aqueduct_projects/pcrglobwb_runs/for_flood_analyzer/rcp4p5/pcrglobwb_runs_2016_oct_nov/tar_archive_edwinsut/"
